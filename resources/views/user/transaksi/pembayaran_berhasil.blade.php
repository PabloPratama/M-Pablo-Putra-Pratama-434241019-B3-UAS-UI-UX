...
<div class="min-h-screen flex items-start justify-center font-['Poppins'] px-4 pt-2 md:pt-4 pb-16">
    ...
    <div class="w-full max-w-3xl flex flex-col items-center">
        ...
        <div class="relative flex items-center justify-center w-40 h-40 md:w-52 md:h-52 mb-6">
            <div class="absolute inset-0 bg-[#4CEF2F] bg-opacity-10 rounded-full animate-ping opacity-75"></div>
            <div class="absolute inset-0 bg-[#4CEF2F] bg-opacity-10 rounded-full"></div>
            
            <div class="relative bg-[#4CEF2F] w-32 h-32 md:w-40 md:h-40 rounded-full flex items-center justify-center shadow-lg">
                <svg class="w-18 h-18 md:w-24 md:h-24 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="w-full rounded-2xl p-8 md:p-14 border transition-all duration-300"
            ...
            <a href="{{ route('katalog.detail') }}" 
                class="w-full sm:w-auto text-center px-10 py-4 rounded-xl font-semibold text-white text-base shadow-lg transition-all duration-200 hover:brightness-90"
                style="background: linear-gradient(to right, #D17CE3, #B87BFF);">
                Baca Novelnya Sekarang
            </a>
        </div>
        </div>
    </div>
